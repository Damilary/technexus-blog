...
const mockAuthors: Record<string, Author> = {
  "sarah-johnson": {
    ...
    bio: "Sarah is a leading researcher in AI ethics and applications, focusing on the societal impact of machine learning.",
  },
  "michael-chen": {
    id: "michael-chen",
    name: "Michael Chen",
    avatar: "/images/authors/michael-chen.jpg",
    bio: "Michael is a full-stack developer with a passion for decentralized technologies and building the future of the web.",
  },
  "priya-sharma": {
    id: "priya-sharma",
    name: "Priya Sharma",
    avatar: "/images/authors/priya-sharma.jpg",
    bio: "Priya explores the intersection of quantum physics and computer science, seeking practical applications for complex theories.",
  },
  "james-wilson": {
    id: "james-wilson",
    name: "James Wilson",
    avatar: "/images/authors/james-wilson.jpg",
    bio: "James is a cybersecurity expert with over 15 years of experience protecting organizations from digital threats.",
  },
  "alex-rodriguez": {
    id: "alex-rodriguez",
    name: "Alex Rodriguez",
    avatar: "/images/authors/alex-rodriguez.jpg",
    bio: "Alex is a frontend architect specializing in React and Next.js, dedicated to building performant and scalable web applications.",
  },
  "emma-thompson": {
    id: "emma-thompson",
    name: "Emma Thompson",
    avatar: "/images/authors/emma-thompson.jpg",
    bio: "Emma focuses on design systems and CSS architecture, helping teams create maintainable and beautiful user interfaces.",
  },
  "david-kim": {
    id: "david-kim",
    name: "David Kim",
    avatar: "/images/authors/david-kim.jpg",
    bio: "David is an advocate for web accessibility, ensuring digital experiences are inclusive for everyone.",
  },
  "sophia-martinez": {
    id: "sophia-martinez",
    name: "Sophia Martinez",
    avatar: "/images/authors/sophia-martinez.jpg",
    bio: "Sophia designs and builds robust APIs, focusing on developer experience and system scalability.",
  },
  "thomas-anderson": {
    id: "thomas-anderson",
    name: "Thomas Anderson",
    avatar: "/images/authors/thomas-anderson.jpg",
    bio: "Thomas works on the edge, literally. He specializes in IoT and edge computing solutions.",
  },
  "olivia-wang": {
    id: "olivia-wang",
    name: "Olivia Wang",
    avatar: "/images/authors/olivia-wang.jpg",
    bio: "Olivia applies machine learning techniques to solve real-world industrial problems, particularly in predictive maintenance.",
  },
  "robert-johnson": {
    id: "robert-johnson",
    name: "Robert Johnson",
    avatar: "/images/authors/robert-johnson.jpg",
    bio: "Robert investigates the potential of blockchain technology beyond finance, exploring its use in logistics and healthcare.",
  },
  "natalie-brown": {
    id: "natalie-brown",
    name: "Natalie Brown",
    avatar: "/images/authors/natalie-brown.jpg",
    bio: "Natalie combines psychology and design to create user experiences that are both effective and delightful.",
  },
  "daniel-lee": {
    id: "daniel-lee",
    name: "Daniel Lee",
    avatar: "/images/authors/daniel-lee.jpg",
    bio: "Daniel is a cloud architect specializing in serverless technologies and optimizing cloud infrastructure.",
  },
  "current-user": {
    id: "current-user",
    name: "Mock User",
...
const mockComments: Record<string, Comment[]> = {
  "future-of-ai-2025": [
    {
      id: "c1",
      content:
        "Great overview! The impact on healthcare is particularly fascinating.",
      createdAt: "2025-05-21T10:00:00Z",
      author: mockAuthors["michael-chen"],
    },
    {
      id: "c2",
      content:
        "I'm concerned about the ethical implications. How can we ensure fairness?",
      createdAt: "2025-05-21T11:30:00Z",
      author: mockAuthors["priya-sharma"],
    },
    {
      id: "c3",
      content:
        "Excellent points on the challenges. Regulation needs to catch up quickly.",
      createdAt: "2025-05-22T09:15:00Z",
      author: mockAuthors["james-wilson"],
    },
  ],
  "web3-development-guide": [
    {
      id: "c4",
      content:
        "This is a fantastic starting point for anyone looking to get into Web3 dev.",
      createdAt: "2025-05-20T14:00:00Z",
      author: mockAuthors["alex-rodriguez"],
    },
    {
      id: "c5",
      content:
        "Learning Solidity is key! Also, understanding gas fees is crucial.",
      createdAt: "2025-05-20T16:25:00Z",
      author: mockAuthors["emma-thompson"],
    },
  ],
  ...
  "cybersecurity-ai-threats-defenses": [
    {
      id: "c8",
      content: "The dual nature of AI in security is well explained.",
      createdAt: "2025-05-18T10:00:00Z",
      author: mockAuthors["thomas-anderson"],
    },
  ],
  "nextjs-15-new-features": [
    {
      id: "c6",
      content: "Partial Prerendering sounds very promising!",
      createdAt: "2025-05-17T08:00:00Z",
      author: mockAuthors["david-kim"],
    },
    {
      id: "c7",
      content: "Can't wait to try out the improved Server Actions.",
      createdAt: "2025-05-17T09:30:00Z",
      author: mockAuthors["sophia-martinez"],
    },
  ],
  "css-architecture-large-applications": [
    {
      id: "c9",
      content: "Tailwind has been a game-changer for our team.",
  ...
  "building-accessible-web-applications": [
    ...
    {
      id: "c11",
      content: "Great reminder of the WCAG principles.",
      createdAt: "2025-05-15T15:45:00Z",
      author: mockAuthors["natalie-brown"],
    },
  ],
  "api-design-best-practices": [
    {
      id: "c12",
      content: "Consistency is key! Makes consuming the API so much easier.",
  ...
  "edge-computing-iot-ecosystems": [
    {
      id: "c13",
      content:
        "Reduced latency is critical for our real-time IoT applications.",
  ...
  "machine-learning-predictive-maintenance": [
    {
      id: "c14",
      content:
        "The cost savings from predictive maintenance can be substantial.",
      createdAt: "2025-05-12T09:00:00Z",
      author: mockAuthors["olivia-wang"],
    },
  ],
  "blockchain-beyond-cryptocurrency": [
    {
      id: "c15",
      content:
        "Supply chain transparency is a huge potential win for blockchain.",
      createdAt: "2025-05-11T16:00:00Z",
      author: mockAuthors["robert-johnson"],
    },
  ],
  "psychology-of-ux-design": [
    {
      id: "c16",
      content: "Understanding cognitive load has really improved my designs.",
  ...
  "serverless-architecture-benefits-challenges": [
    {
      id: "c17",
      content:
        "Cold starts can be tricky, but often manageable with optimization.",
      createdAt: "2025-05-09T15:00:00Z",
      author: mockAuthors["daniel-lee"],
    },
  ],
};
...
const mockArticles: Article[] = [
  {
    ...
    excerpt:
      "Explore the upcoming trends in artificial intelligence, from advancements in NLP to the rise of ethical AI frameworks.",
    slug: "future-of-ai-2025",
    coverImage: { url: "/images/articles/ai-future.jpg" },
    ...
    author: {
      name: "Sarah Johnson",
      picture: "/images/authors/sarah-johnson.jpg",
    },
  },
  {
    id: "2",
    ...
    excerpt:
      "Dive into the world of decentralized applications, smart contracts, and blockchain technology.",
    slug: "web3-development-guide",
    coverImage: { url: "/images/articles/web3-dev.jpg" },
    ...
    author: {
      name: "Michael Chen",
      picture: "/images/authors/michael-chen.jpg",
    },
  },
  {
    id: "3",
    ...
    excerpt:
      "How quantum computers could revolutionize industries like finance, medicine, and materials science.",
    slug: "quantum-computing-business-applications",
    coverImage: { url: "/images/articles/quantum-computing.jpg" },
    ...
    author: {
      name: "Priya Sharma",
      picture: "/images/authors/priya-sharma.jpg",
    },
  },
  {
    id: "4",
    ...
    excerpt:
      "Understanding how AI is used by both attackers and defenders in the evolving landscape of cybersecurity.",
    slug: "cybersecurity-ai-threats-defenses",
    coverImage: { url: "/images/articles/cybersecurity-ai.jpg" },
    ...
    author: {
      name: "James Wilson",
      picture: "/images/authors/james-wilson.jpg",
    },
  },
  {
    id: "5",
    ...
    excerpt:
      "A deep dive into the latest updates and improvements in the popular React framework.",
    slug: "nextjs-15-new-features",
    coverImage: { url: "/images/articles/nextjs-logo.jpg" },
    ...
    author: {
      name: "Alex Rodriguez",
      picture: "/images/authors/alex-rodriguez.jpg",
    },
  },
  {
    id: "6",
    ...
    excerpt:
      "Strategies and methodologies for writing maintainable and scalable CSS in complex projects.",
    slug: "css-architecture-large-applications",
    coverImage: { url: "/images/articles/css-architecture.jpg" },
    ...
    author: {
      name: "Emma Thompson",
      picture: "/images/authors/emma-thompson.jpg",
    },
  },
  {
    id: "7",
    ...
    excerpt:
      "Tips and techniques for ensuring your web apps are usable by everyone, including people with disabilities.",
    slug: "building-accessible-web-applications",
    coverImage: { url: "/images/articles/accessibility.jpg" },
    ...
    author: {
      name: "David Kim",
      picture: "/images/authors/david-kim.jpg",
    },
  },
  {
    id: "8",
    ...
    excerpt:
      "Learn how to design robust, scalable, and developer-friendly APIs using REST and GraphQL principles.",
    slug: "api-design-best-practices",
    coverImage: { url: "/images/articles/api-design.jpg" },
    ...
    author: {
      name: "Sophia Martinez",
      picture: "/images/authors/sophia-martinez.jpg",
    },
  },
  {
    id: "9",
    ...
    excerpt:
      "How processing data closer to the source is transforming IoT applications and enabling new possibilities.",
    slug: "edge-computing-iot-ecosystems",
    coverImage: { url: "/images/articles/edge-computing.jpg" },
    ...
    author: {
      name: "Thomas Anderson",
      picture: "/images/authors/thomas-anderson.jpg",
    },
  },
  {
    id: "10",
    ...
    excerpt:
      "Using ML algorithms to predict equipment failures and optimize maintenance schedules.",
    slug: "machine-learning-predictive-maintenance",
    coverImage: { url: "/images/articles/predictive-maintenance.jpg" },
    ...
    author: {
      name: "Olivia Wang",
      picture: "/images/authors/olivia-wang.jpg",
    },
  },
  {
    id: "11",
    ...
    excerpt:
      "Exploring the potential of blockchain in supply chain management, healthcare, voting, and more.",
    slug: "blockchain-beyond-cryptocurrency",
    coverImage: { url: "/images/articles/blockchain-apps.jpg" },
    ...
    author: {
      name: "Robert Johnson",
      picture: "/images/authors/robert-johnson.jpg",
    },
  },
  {
    id: "12",
    ...
    excerpt:
      "How understanding cognitive biases and psychological principles can lead to better UX.",
    slug: "psychology-of-ux-design",
    coverImage: { url: "/images/articles/ux-psychology.jpg" },
    ...
    author: {
      name: "Natalie Brown",
      picture: "/images/authors/natalie-brown.jpg",
    },
  },
  {
    id: "13",
    ...
    excerpt:
      "An overview of serverless computing, its advantages, and potential drawbacks to consider.",
    slug: "serverless-architecture-benefits-challenges",
    coverImage: { url: "/images/articles/serverless.jpg" },
    ...
    author: {
      name: "Daniel Lee",
      picture: "/images/authors/daniel-lee.jpg",
    },
  },
];
...
const mockCategories: CategoryDetails[] = [
  {
    ...
    slug: "ai-ml",
    description:
      "Latest advancements and applications in Artificial Intelligence and Machine Learning.",
    availableTags: [
      "AI",
      "Machine Learning",
      "Ethics",
  ...
  },
  {
    ...
    description:
      "Tutorials, frameworks, and best practices for modern web development.",
    availableTags: [
      "Web3",
      "Blockchain",
      "Solidity",
  ...
  },
  {
    ...
    slug: "emerging-tech",
    description:
      "Exploring the frontiers of technology, from quantum computing to blockchain.",
    availableTags: [
      "Quantum Computing",
      "Business",
      "Innovation",
  ...
  },
  {
    ...
    availableTags: ["Cybersecurity", "AI", "Threat Intelligence", "Security"],
  },
  {
    id: "cat-5",
    ...
    description:
      "Principles and practices for building robust and scalable software.",
    availableTags: ["API", "REST", "GraphQL", "Backend", "Software Design"],
  },
  {
    id: "cat-6",
    name: "Cloud & Infrastructure",
    slug: "cloud-infrastructure",
    description: "Cloud computing, DevOps, and infrastructure management.",
    availableTags: [
      "Edge Computing",
      "IoT",
      "Cloud Computing",
  ...
  },
  {
    ...
    name: "Design & UX",
    slug: "design-ux",
    description: "Creating effective and engaging user experiences.",
    availableTags: [
      "UX",
      "UI",
      "Design",
...
// Define the Article type to include all used properties
export type Article = {
  id: string;
  title: string;
  description: string;
...
export const mockFeaturedArticles: Article[] = [
  {
    ...
    description: 'How artificial intelligence is transforming the medical field.',
  ...
  },
  {
    ...
    description: 'A beginner’s guide to quantum computers and their potential.',
...
export const mockTopPicks: Article[] = [
  {
    id: '3',
    title: 'The Future of Renewable Energy',
    description: 'Exploring sustainable energy sources for a greener planet.',
  ...
  },
  {
    ...
    description: 'Applications of blockchain technology in various industries.',
...
export const mockGraphQLHandler = async <TData = any>(
  ...
  switch (operationName) {
    case "GetHeroArticle":
      return { heroArticle: mockArticles[0] } as TData;
    ...
    case "GetTopPicks":
      return {
        topPicks: mockTopPicks.slice(0, variables?.limit ?? 5),
      } as TData;
    ...
    case "SearchArticles":
      ...
      const searchResults = mockArticles.filter(
        (a) =>
      ...
      const searchPaginated = searchResults.slice(
        searchOffset,
    ...
    case "GetArticleDetails":
      ...
      const fullArticleDetail = {
        ...articleDetail,
        content:
          mockArticleContent[articleSlug] || "Article content not found.",
    ...
    case "GetRelatedArticles":
      ...
      const related = mockArticles
        .filter(
          (a) =>
            a.category.slug === currentArticle.category.slug &&
            a.slug !== relatedSlug
        )
    ...
    case "CreateComment":
      ...
      console.log(
        `[Mock API] Added comment to ${createCommentSlug}:`,
        newComment
      );
    ...
    case "UpdateUserPreferences":
      ...
      mockUserPreferences = {
        ...mockUserPreferences,
        ...(variables?.darkMode !== undefined && {
          darkMode: variables.darkMode,
        }),
        ...(variables?.emailNotificationsEnabled !== undefined && {
          emailNotificationsEnabled: variables.emailNotificationsEnabled,
        }),
        ...(variables?.favoriteCategories && {
          favoriteCategories: variables.favoriteCategories,
        }),
        ...(variables?.preferredLevel && {
          preferredLevel: variables.preferredLevel,
        }),
        ...(variables?.preferredFormats && {
          preferredFormats: variables.preferredFormats,
        }),
      };
      console.log(
        "[Mock API] Updated mockUserPreferences:",
        mockUserPreferences
      );
    ...
    case "SubscribeToNewsletter":
      ...
      console.log(
        `[Mock API] Attempting newsletter subscription for: ${email}`
      );
      ...
      if (email === "error@example.com") {
        console.log(
          "[Mock API] Simulating server error for newsletter subscription."
        );
      ...
      console.log(
        `[Mock API] Added ${email} to subscribers. Total: ${mockNewsletterSubscribers.size}`
      );
      return {
        subscribeToNewsletter: {
          success: true,
    ...
    case "RequestPasswordReset":
      ...
      if (!resetEmail || mockUserProfile.email !== resetEmail) {
        // Simple check against mock user
        console.log(
          "[Mock API] Email not found for password reset (or doesn't match mock user)."
        );
      ...
      const resetToken = `reset-${Date.now()}-${Math.random()
        .toString(36)
        .substring(2)}`;
      mockPasswordResetTokens.set(resetEmail, resetToken);
      console.log(
        `[Mock API] Generated password reset token for ${resetEmail}: ${resetToken} (Simulating email send)`
      );
      return {
        requestPasswordReset: {
          success: true,
    ...
    case "ResetPassword":
      ...
      console.log(
        `[Mock API] Attempting password reset with token: ${providedResetToken}`
      );
      ...
      if (foundEmail && mockUserProfile.email === foundEmail) {
        console.log(
          `[Mock API] Valid reset token found for ${foundEmail}. Updating password.`
        );
        // Simulate password update (no actual hashing)
        mockPasswordResetTokens.delete(foundEmail); // Remove used token
        console.log(
          `[Mock API] Password for ${foundEmail} updated to ${newPassword} (mock).`
        );
        return {
          resetPassword: {
            success: true,
    ...
    case "RequestEmailVerification":
      ...
      console.log(
        `[Mock API] Requesting email verification for: ${mockUserProfile.email}`
      );
      ...
      const verificationToken = `verify-${Date.now()}-${Math.random()
        .toString(36)
        .substring(2)}`;
      const expiresAt = Date.now() + 3600 * 1000; // Expires in 1 hour
      mockEmailVerificationTokens.set(verificationToken, {
        token: verificationToken,
        userId: mockUserProfile.id,
        expiresAt,
      });
      console.log(
        `[Mock API] Generated verification token for ${mockUserProfile.email}: ${verificationToken} (Simulating email send)`
      );
      return {
        requestEmailVerification: {
          success: true,
    ...
    case "VerifyEmail":
      ...
      console.log(
        `[Mock API] Attempting email verification with token: ${providedVerifyToken}`
      );
      const tokenInfo = mockEmailVerificationTokens.get(providedVerifyToken);

      if (
        tokenInfo &&
        tokenInfo.userId === mockUserProfile.id &&
        Date.now() < tokenInfo.expiresAt
      ) {
        console.log(
          `[Mock API] Valid verification token found for user ${tokenInfo.userId}. Verifying email.`
        );
